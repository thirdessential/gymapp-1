...
const ProfileOverview = (props) => {
  return (
    <View
      ...
      {
        props.userType === userTypes.TRAINER && props.userType !== props.myUserType  &&<TouchableOpacity onPress={props.onHitsPress} activeOpacity={0.7} style={styles.profileHitsContainer}>
