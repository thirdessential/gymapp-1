...
import RoundedDP from "../../components/RoundedDP";
    ...
    return (
      ...
      <View style={{flex:1}}>
          ...
          <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
            <RoundedDP url={displayPictureUrl}  size={spacing.coverImageSize} border={true}/>
          </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(ProfileTwo);